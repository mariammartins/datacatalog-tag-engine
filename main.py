...
##################### CONFIGURE TAG HISTORY (OLD FUNCTION) ##################################
...
def configure_tag_history():
    ...
    if ENABLE_TAG_HISTORY:
        ...
        if TAG_HISTORY_PROJECT == None:
            ...
            return jsonify({"status": "error", "message": "TAG_HISTORY_PROJECT is missing from configuration."}), 400


        if TAG_HISTORY_DATASET == None:
            print('Error: unable to configure tag history, TAG_HISTORY_DATASET is missing from tagengine.ini')
            return jsonify({"status": "error", "message": "TAG_HISTORY_DATASET is missing from configuration."}), 400
        ...
        if status:
            ...
            return jsonify({"status": "success", "message": "Tag history configured successfully."})
